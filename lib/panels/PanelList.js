  ...
  _createClass(PanelList, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        { className: 'propertyPanel', closeOnEsc: true, closeOnOutsideClick: true, isOpened: true },
        _react2.default.createElement(
          'div',
          { style: [_styles2.default.propertyPanel, style] },
          objectComponent.panels.map(function (Panel, i) {
            return _react2.default.createElement(Panel, _extends({ key: i, id: id }, _this2.props));
          })
        )
      );
    }
